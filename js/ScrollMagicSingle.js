...
function scrollImagesUp(controller) {
  ...
  var scene3 = new ScrollMagic.Scene({ triggerElement: "#text-anchor", duration: 400, offset: 400 })
    .setTween(tween)
    .addTo(controller);
    ...
    var scene3 = new ScrollMagic.Scene({ triggerElement: "#text-anchor", duration: 400, offset: 900 })
    .setTween(tween)
    .addTo(controller);
  }
}