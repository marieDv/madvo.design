        ...
        if (back[i]) {
            back[i].addEventListener("click", function () {
                ...
                if (document.getElementsByClassName("wheel-item__content")[i - 1]) {
                    document.getElementsByClassName("wheel-item__content")[i - 1].classList.remove("wheel-item__content--active");
                }
                ...
                if (item[i]) {
                    item[i].classList.remove("wheel-item__image--active");
                }
